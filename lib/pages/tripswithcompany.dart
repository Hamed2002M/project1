...
class TripsWithAirplane extends StatelessWidget {
   TripsWithAirplane({required this.airplaneforsearchtrip});
 final Airplanedata airplaneforsearchtrip ;
  @override
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:  FutureBuilder(
                future: Searchtripviacountryorcompanyservice().searchTripViaCountryOrCompanyService("${airplaneforsearchtrip.name}"),
